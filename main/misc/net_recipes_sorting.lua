...
SortAfter("turf_frozenfloor",           "turf_snowfall",            "DECOR")
SortAfter("turf_redcarpet",             "turf_frozenfloor",         "DECOR")
...
SortAfter("turf_toadstoolrug",          "turf_darkrosecarpet",      "DECOR")
...
SortAfter("turf_mosaic_white",          "turf_goldroad",            "DECOR")
