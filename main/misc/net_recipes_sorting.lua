...
SortAfter("kyno_terraform_barrel_item", "gunpowder",                "WEAPONS")
...
SortAfter("turf_rosecarpet",            "turf_upholdercarpet",      "DECOR")
SortAfter("turf_limecarpet",            "turf_rosecarpet",          "DECOR")
SortAfter("turf_flowercarpet",          "turf_limecarpet",          "DECOR")
SortAfter("turf_darkrosecarpet",        "turf_flowercarpet",        "DECOR")
SortAfter("turf_camogreencarpet",       "turf_darkrosecarpet",      "DECOR")
SortAfter("turf_camocarpet",            "turf_camogreencarpet",     "DECOR")
SortAfter("turf_strawcarpet",           "turf_camocarpet",          "DECOR")
SortAfter("turf_linescarpet",           "turf_strawcarpet",         "DECOR")
SortAfter("turf_linescarpet2",          "turf_linescarpet",         "DECOR")
SortAfter("turf_linescarpet3",          "turf_linescarpet2",        "DECOR")
SortAfter("turf_wavescarpet",           "turf_linescarpet3",        "DECOR")
SortAfter("turf_screwcarpet",           "turf_wavescarpet",         "DECOR")
SortAfter("turf_flowered",              "turf_screwcarpet",         "DECOR")
SortAfter("turf_flowered2",             "turf_flowered",            "DECOR")
SortAfter("turf_beefalorug",            "turf_flowered2",           "DECOR")
SortAfter("turf_slurperrug",            "turf_beefalorug",          "DECOR")
SortAfter("turf_toadstoolrug",          "turf_slurperrug",          "DECOR")
SortAfter("turf_modern_cobblestones",   "turf_toadstoolrug",        "DECOR")
...
SortAfter("turf_woodgreen",             "turf_livinglog",           "DECOR")
SortAfter("turf_woodred",               "turf_woodgreen",           "DECOR")
SortAfter("turf_woodblue",              "turf_woodred",             "DECOR")
SortAfter("turf_woodpurple",            "turf_woodblue",            "DECOR")
SortAfter("turf_woodblack",             "turf_woodpurple",          "DECOR")
SortAfter("turf_hardwood",              "turf_woodblack",           "DECOR")
...
SortAfter("turf_moonrockfloor",         "turf_lunarrift",           "DECOR")
SortAfter("turf_vaultmossy",            "turf_moonrockfloor",       "DECOR")
SortAfter("turf_thulecite",             "turf_vaultmossy",          "DECOR")
SortAfter("turf_thulecite2",            "turf_thulecite",           "DECOR")
SortAfter("turf_thulecite3",            "turf_thulecite2",          "DECOR")
SortAfter("turf_wagpunkfloor",          "turf_thulecite3",          "DECOR")
...
SortAfter("turf_mossybrick",            "turf_whitebrick",          "DECOR")
SortAfter("turf_goldroad",              "turf_mossybrick",          "DECOR")
SortAfter("turf_smallbricks",           "turf_goldroad",            "DECOR")
SortAfter("turf_squaredtiles",          "turf_smallbricks",         "DECOR")
SortAfter("turf_pooltiles",             "turf_squaredtiles",        "DECOR")
SortAfter("turf_marbleoctagon",         "turf_pooltiles",           "DECOR")
SortAfter("turf_gravel",                "turf_marbleoctagon",       "DECOR")
SortAfter("turf_mosaic_white",          "turf_gravel",              "DECOR")
SortAfter("turf_mosaic_black",          "turf_mosaic_white",        "DECOR")
SortAfter("turf_redlawn",               "turf_mosaic_black",        "DECOR")
...
SortAfter("turf_dryrock",               "turf_meadowyellow",        "DECOR")
SortAfter("turf_aridrocky",             "turf_dryrock",             "DECOR")
...
SortAfter("turf_redgrass",              "turf_savannagreen",        "DECOR")
SortAfter("turf_purplegrass",           "turf_redgrass",            "DECOR")
SortAfter("turf_turquoise_deciduous",   "turf_purplegrass",         "DECOR")
SortAfter("turf_manure",                "turf_turquoise_deciduous", "DECOR")
SortAfter("turf_mudwet",                "turf_manure",              "DECOR")
SortAfter("turf_quicksand",             "turf_mudwet",              "DECOR")
SortAfter("turf_stickywebbing",         "turf_quicksand",           "DECOR")
...
SortAfter("turf_marbleslate",           "turf_octagon",             "DECOR")
SortAfter("turf_marbleflower",          "turf_marbleslate",         "DECOR")
SortAfter("turf_clovertiles",           "turf_marbleflower",        "DECOR")
SortAfter("turf_parquet",               "turf_clovertiles",         "DECOR")
SortAfter("turf_absmarble",             "turf_parquet",             "DECOR")
SortAfter("turf_mosaicfloor",           "turf_absmarble",           "DECOR")
SortAfter("turf_checkermosaic",         "turf_mosaicfloor",         "DECOR")
SortAfter("turf_marbleblue",            "turf_checkermosaic",       "DECOR")
