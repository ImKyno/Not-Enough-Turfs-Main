...
TUNING.NET_IS_IAS_ENABLED = _G.KnownModIndex:IsModEnabled("workshop-1467214795") -- Island Adventures.
TUNING.NET_IS_IAC_ENABLED = _G.KnownModIndex:IsModEnabled("workshop-3435352667") -- Island Adventures Core.
