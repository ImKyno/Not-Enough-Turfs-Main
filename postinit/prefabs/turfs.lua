...
local MODDED_TURFS =
{
	...
	turf_woodred             = "WOOD",
	turf_woodblue            = "WOOD",
	turf_woodpurple          = "WOOD",
	turf_woodblack           = "WOOD",
	turf_mossybrick          = "STONE",
	turf_goldroad            = "ROAD",
	turf_mosaic_white        = "STONE",
	turf_mosaic_black        = "STONE",
	turf_redgrass            = "FOREST",
	turf_purplegrass         = "FOREST",
	turf_turquoise_deciduous = "GRASS",
	turf_manure              = "MUDDY",
	turf_rosecarpet          = "CARPET",
	turf_limecarpet          = "CARPET",
	turf_flowercarpet        = "CARPET",
	turf_darkrosecarpet      = "CARPET",
	turf_mudwet              = "MUDDY",
	turf_quicksand           = "SAND",
	turf_thulecite           = "ANCIENT",
	turf_thulecite2          = "ANCIENT",
	turf_thulecite3          = "ANCIENT",
	turf_toadstoolrug        = "TOAD",
	turf_moonrockfloor       = "STONE",
	turf_beefalorug          = "CARPET",
	turf_slurperrug          = "CARPET",
	turf_camocarpet          = "CARPET",
	turf_camogreencarpet     = "CARPET",
	turf_strawcarpet         = "CARPET",
	turf_linescarpet         = "CARPET",
	turf_linescarpet2        = "CARPET",
	turf_linescarpet3        = "CARPET",
	turf_wavescarpet         = "CARPET",
	turf_screwcarpet         = "CARPET",
	turf_dryrock             = "ROCKY",
	turf_marbleoctagon       = "MARBLE",
	turf_smallbricks         = "ROAD",
	turf_squaredtiles        = "ROAD",
	turf_pooltiles           = "STONE",
	turf_gravel              = "ROAD",
	turf_flowered            = "CARPET",
	turf_flowered2           = "CARPET",
	...
	turf_hoof                = "MARBLE",
	turf_octagon             = "MARBLE",
	turf_marbleslate         = "MARBLE",
	turf_marbleflower        = "MARBLE",
	turf_clovertiles         = "MARBLE",
	turf_parquet             = "MARBLE",
	turf_absmarble           = "MARBLE",
	turf_mosaicfloor         = "MARBLE",
	turf_checkermosaic       = "MARBLE",
	turf_marbleblue          = "MARBLE",
}
