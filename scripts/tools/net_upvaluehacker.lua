...
function NETUpvalueHacker.GetUpvalue(fn, ...)
...
function NETUpvalueHacker.SetUpvalue(start_fn, new_fn, ...)
	local _fn, _fn_i, scope_fn = NETUpvalueHacker.GetUpvalue(start_fn, ...)
	debug.setupvalue(scope_fn, _fn_i, new_fn)
end

return NETUpvalueHacker